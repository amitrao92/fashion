									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												...
												<div class="controls">
			                                    <input type="text" name="productDescription" placeholder="Enter Product Description" value="<?php echo htmlentities($row['productDescription']); ?>" class="span8 tip">
												</div>
											</div>
											...
											<!-- <div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php //echo htmlentities($pid); 
																			?>/<?php echo htmlentities($row['productImage2']); ?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id']; ?>">Change Image</a>
												</div>
											</div> -->
											...
											<!-- <div class="control-group">
												...
												<div class="controls">
													<img src="productimages/<?php //echo htmlentities($pid); 
																			?>/<?php echo htmlentities($row['productImage3']); ?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id']; ?>">Change Image</a>
												</div>
											</div> -->
										<?php } ?>
										<div class="control-group">
