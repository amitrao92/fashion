<div class="span3">
	<div class="sidebar">
		...
		<ul class="widget widget-menu unstyled">
			...
			<li><a href="contactlist.php"><i class="menu-icon icon-table"></i>Contact List </a></li>
			<li><a href="onlinepay_detail.php"><i class="menu-icon icon-table"></i>Checkout Detail List </a></li>
		...
		<ul class="widget widget-menu unstyled">
		<!-- <li><a href="user-manage.php"><i class="menu-icon icon-tasks"></i>User Block/Unblock </a></li> -->
