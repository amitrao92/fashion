										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
                                                      <?php   if($row['status']==1){
														  echo '<p><a href="edit-user-manage.php?id='.$row['id'].'&status=0" class="label label-danger">Block</a></p>';
														}else{
															echo '<p><a href="edit-user-manage.php?id='.$row['id'].'&status=1" class="label label-success">Unblock</a></p>';														}
?>
