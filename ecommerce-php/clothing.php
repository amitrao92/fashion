...
if (isset($_GET['action']) && $_GET['action'] == "add") {
	...
	if (isset($_SESSION['cart'][$id])) {
		...
		if (mysqli_num_rows($query_p) != 0) {
			...
			echo "<script type='text/javascript'> document.location ='clothing.php?cid=13'; </script>";
					...
					<div class="search-result-container">
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active " id="grid-container">
								...
								<h3 class="section-title">Clothing Featured List</h3>
																	...
																	<ul class="list-unstyled">
																		<li class="add-cart-button btn-group">
																			<?php if ($row['productAvailability'] == 'In Stock') { ?>
																				...
																				<a href="clothing.php?cid=13&page=product&action=add&id=<?php echo $row['id']; ?>">
																		...
																		<li class="lnk wishlist">
																			<a class="add-to-cart" href="clothing.php?cid=13&pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist" title="Wishlist">
								...
								<br>
								<h3 class="section-title">Clothing Top Section</h3>
								<div class="row">
									<?php
									$ret = mysqli_query($con, "select * from products where category=14 and subCategory=33");
									$num = mysqli_num_rows($ret);
									if ($num > 0) {
										while ($row = mysqli_fetch_array($ret)) { ?>
											<div class="col-sm-6 col-md-4 wow fadeInUp">
								...
								<br>
								<h3 class="section-title">Clothing Bottom Section</h3>
								<div class="row">
									<?php
									$ret = mysqli_query($con, "select * from products where category=14 and subCategory=34");
									$num = mysqli_num_rows($ret);
									if ($num > 0) {
										while ($row = mysqli_fetch_array($ret)) { ?>
											<div class="col-sm-6 col-md-4 wow fadeInUp">
