...
if (isset($_GET['action']) && $_GET['action'] == "add") {
	...
	if (isset($_SESSION['cart'][$id])) {
		...
		if (mysqli_num_rows($query_p) != 0) {
			...
			echo "<script type='text/javascript'> document.location ='fashion-week-m.php?cid=12'; </script>";
		} else {
																	...
																	<ul class="list-unstyled">
																		<li class="add-cart-button btn-group">
																			<?php if ($row['productAvailability'] == 'In Stock') { ?>
																				...
																				<a href="fashion-week-m.php?cid=12&page=product&action=add&id=<?php echo $row['id']; ?>">
																		...
																		<li class="lnk wishlist">
																			<a class="add-to-cart" href="fashion-week-m.php?cid=12&pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist" title="Wishlist">
