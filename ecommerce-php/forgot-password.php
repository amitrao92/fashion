...
if (isset($_POST['change'])) {
	...
	$query = mysqli_query($con, "SELECT * FROM users WHERE email='$email' and faq_question='$faq_question' and faq_answer='$faq_answer' and contactno='$contact'");
...
<head>
	...
	<title>WARDROAB | Forgot Password</title>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 sign-in">
						...
						<form class="register-form outer-top-xs" name="register" method="post">
							...
							<div class="form-group">
								<label class="info-title" for="exampleInputfaqquestion">FAQ Question <span>*</span></label>
							...
							<div class="form-group">
								<label class="info-title" for="exampleInputfaqanswer">FAQ Answer <span>*</span></label>
								<input type="text" name="faq_answer" class="form-control unicase-form-control text-input" id="contact" required>
							</div>
							<div class="form-group">
