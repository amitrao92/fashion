...
if (isset($_GET['action']) && $_GET['action'] == "add") {
	...
	if (isset($_SESSION['cart'][$id])) {
		...
		if (mysqli_num_rows($query_p) != 0) {
			...
			echo "<script type='text/javascript'> document.location ='new_in.php?cid=13'; </script>";
		} else {
																	...
																	<ul class="list-unstyled">
																		<li class="add-cart-button btn-group">
																			<?php if ($row['productAvailability'] == 'In Stock') { ?>
																				...
																				<a href="new_in.php?cid=13&page=product&action=add&id=<?php echo $row['id']; ?>">
																		...
																		<li class="lnk wishlist">
																			<a class="add-to-cart" href="new_in.php?cid=13&pid=<?php echo htmlentities($row['id']) ?>&&action=wishlist" title="Wishlist">
